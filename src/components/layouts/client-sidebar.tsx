...
export const ClientSidebar = ({ className }: { className?: string }) => {
    const links = [
        {
            label: "Models",
            href: "/client/model",
        ...
        },
        {
            ...
            href: "/client/spectra",
            icon: (
                <IconAlignBoxBottomCenter className="text-foreground h-7 w-6 flex-shrink-0" />
            ),
        },
        {
            label: "Profile",
            href: "/client/profile",
            icon: (
                <User2Icon className="text-foreground h-7 w-6 flex-shrink-0" />
            ),
        },
    ]
