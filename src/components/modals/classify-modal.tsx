...
import { useGetAllSpectraQuery } from "@/redux/services/client/spectra.api"
...
export const RunClassifyModelModal = ({ model }: { model: IModelRes }) => {
    ...
    return (
        <div className="w-full flex justify-center">
            <Dialog>
                ...
                <DialogContent className="w-[84%] sm:max-w-[55%] h-[80%] sm:max-h-[74%] bg-light-card flex justify-between py-8 px-8">
                    <div className="flex flex-col">
                        ...
                        {selectedSpectra && (
                            <div className="flex flex-col w-[52vh] h-[44vh] bg-card/40 mt-8 rounded-lg p-4">
...
const ResultRunModel = ({
    ...
    const recordsArray = Array.isArray(listRecords)
        ...
        : []
    return (
        <div className="flex flex-col gap-x-2 justify-center text-lg font-semibold bg-accent/10 h-[36%] w-full rounded-lg py-4 px-6 text-foreground/80">
